...
const menuPage = () => {
  ...
  cardContent.forEach((cardInfo) => {
    ...
    const cardMenuTitle = document.createElement('div');
    cardMenuTitle.classList.add('card-title', 'font-weight-bold', 'font-italic');
    cardMenuTitle.textContent = cardTitle;
    textContainer.appendChild(cardMenuTitle);
